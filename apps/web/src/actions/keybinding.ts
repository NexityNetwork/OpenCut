...
/**
 * Runtime guard for {@link ShortcutKey}: either a bare key (e.g. "a", "/",
 * "enter") or a modifier-prefixed key (e.g. "ctrl+a", "ctrl+shift+z").
 */
export function isShortcutKey(value: string): value is ShortcutKey {
	...
	const modifier = value.slice(0, splitIndex);
