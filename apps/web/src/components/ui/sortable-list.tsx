      ...
      <div className="flex w-full items-center">
        <Reorder.Item
          ...
          className={cn(
            ...
            "h-full rounded-xl bg-secondary border border-border",
                  ...
                  >
                    ...
                    <div className="pl-3 pt-1">
                      <Checkbox
                        ...
                        className="  h-5 w-5 rounded-md border-foreground/30 bg-background data-[state=checked]:bg-destructive data-[state=checked]:text-white"
                      />
                    </div>
                    {/* List Order */}
                    ...
                    >
                      <h4
                        className={cn(
                          ...
                          item.checked ? "text-red-400" : "text-foreground/90"
                        )}
                      >
