...
export function TimelinePlayhead({
	...
	return (
		...
		>
			{/* Full-height grab strip: lets you drag the playhead anywhere along the
			    line, not just the small dot at the top. Sits under the dot in the DOM
			    so the dot still wins at the top; the line itself stays non-interactive
			    so it never blocks clicks beyond this ~10px column. */}
			<div
				aria-hidden
				className="pointer-events-auto absolute top-0 left-1/2 h-full w-2.5 -translate-x-1/2 cursor-col-resize"
